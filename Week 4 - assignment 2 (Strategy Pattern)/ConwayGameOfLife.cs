...
namespace ConwayGameOfLife
{
    public class ConwayGameOfLife
    {
        ...
        // implement current behaviour
        public ILifeBehaviour currentBehaviour = new StandardLifeBehaviour();
        ...
        public void Evolve()
        {
            ...
            for (int r = 0; r < HEIGHT; r++)
            {
                ...
                for (int c = 0; c < WIDTH; c++)
                {
                    ...
                    // cell should live?
                    this.Space[r, c] = currentBehaviour.CellShouldLive(livingCell, neighBourCount);
                }
            }
        }
